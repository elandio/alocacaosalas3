...
$(document).ready(function() {
	...
	// consulta o banco e selelciona de acordo com o dia da semana toda a vez
	// que um item for selecionado
	$('select').change(function() {
		...
		$.post("aloccontroller.do", {
			...
			var acres;
			var soma;
			$.each(mapa, function(horario, hst) {// realiza um foreach no
				// hashmap retornado
				var contem = false;
				k++;
				var element = document.createElement('div'); // cria-se o o
				// elemento
				element.id = 'div' + k; // defini diferentes id's
				if (hst.numcre == 3)
					element.className = 'disc3';
				// classe com tamanho padrão dependendo o numero de creditos da
				// disciplina
				else
					element.className = 'disc2';
				...
				$(".horario-" + horario).append(element);// insere a div
				// criada em uma
				// outra div
				// denominada
				// horario
